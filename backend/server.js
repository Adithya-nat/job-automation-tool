...
app.use(function(req, res, next) {
    res.header("Access-Control-Allow-Origin", "https://job-automation-tool-2atkv7fjt-adithyanats-projects.vercel.app"); // update to match the domain you will make the request from
